...
type Props = NativeStackScreenProps<RootStackParams, "AddCommunityName">;

const AddCommunityNamePage = ({ navigation }: Props) => {

  const onContinueClicked = () => navigation.navigate("UploadCommunityPhoto");
...
export default AddCommunityNamePage;