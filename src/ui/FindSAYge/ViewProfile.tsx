...
type Props = NativeStackScreenProps<RootStackParams, "ViewProfile">;

interface ItemProps {
    item: any
}

const ViewProfilePage = ({ navigation }: Props) => {
    ...
    const onMessageClicked = () => navigation.navigate("AboutCommunity");
            ...
            <ScrollView>
                <View style={styles.content}>
                    ...
                    <View style={styles.messageContainer}>
                        <JoinButton
                            text='Message'
                            outerStyle={styles.message}
                            textStyle={styles.messageText}
                            onPress={onMessageClicked} />
